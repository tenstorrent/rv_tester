...
There's a script to generate boilerplate code for PMCs using `pmu/pmu_gen.py`. Just invoke it as-is and it'll pull core_pmc.csv and generate some files.

Copy the following generated files to the appropriate location (look for the AUTOGENERATED comments):
- gen_events.cpp -> pmu/pmu.hpp
