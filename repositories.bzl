...
def rv_tester_repositories():
    ...
    cvm_hash="972e7d951513f6949361250e4747a1e8497344b2"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "403c363c6942fd1cf1821fb68c539ead656a20a44624ebd38979ae49dd44f39f",
    ...
    whisper_hash="7dcb51159ea0ecc99bfa2807f0ccdc892c9a87a8"
    maybe(
        git_repository,
        name = "whisper",
        commit = whisper_hash,
    ...
    checkin_script_hash="0346f43777d5e0c9f196cbc83723db59c0dbb130"
    maybe(
        git_repository,
        name = "checkin-script",
