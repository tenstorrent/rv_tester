...
def rv_tester_repositories():
    ...
    cvm_hash="967e9007464af4fc7d96fa54727a2560dedcbf04"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "0d5b003b8b1d1e2d1e1d90df9f4e4eddc0f582c066508572635afa4290a1b30e",
...
cc_library(
    ...
    checkin_script_hash="8e10278431097e0404b1a97ce8059ac42fb93d92"
    maybe(
        git_repository,
        name = "checkin-script",
