...
def rv_tester_repositories():
    ...
    corearchcoverage_hash="3cac651f11bfdccbab880382e6920a37c2092b71"
    maybe(
        git_repository,
    ...
    cvm_hash="2cd5f1df5b02c4805b3d60c2963b28882fcd3d08"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "6869eec3dc724be8bdd1ba04c1b5a17d54174d84a0d5f2c3a1a62453c0e9d974",
