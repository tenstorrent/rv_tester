...
def rv_tester_repositories():
    ...
    corearchcoverage_hash="a0011e5aba5d8f0eb26ec831ec53bda13ad0be92"
    maybe(
        git_repository,
    ...
    cvm_hash="db7fdaaa564dbc13ea2f642c149c61f79789bf4b"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "f3b7bf150a5298bc054a9f120c222228d8a9beac177011156b4ad8e9c750e91b",
