...
def rv_tester_repositories():
    ...
    cvm_hash="aa5cdd9abbb636162808325a68fcb86f633a44ec"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "0e345dca50b807f20c7b6c997d487b4ca87448a733a2662ebb6b9fcf6194c334",
    ...
    whisper_hash="76948a3ab95afa22ffeb6e570aecdf9a5330afdb"
    maybe(
        git_repository,
        name = "whisper",
        commit = whisper_hash,
    ...
    opensrc_axi_llc_hash="0edbc13bf1299e78f7663215222494854de8cc70"
    maybe(
        git_repository,
