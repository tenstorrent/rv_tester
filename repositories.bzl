...
def rv_tester_repositories():
    ...
    corearchcoverage_hash="1b043b06121d7ae43cec13e9e85ec6b1fce053a6"
    maybe(
        git_repository,
    ...
    cvm_hash="e0b309fbeb6324b72f2ef4bc5bd3003f108ae7a1"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "7180080f3fa71e7ec8b31e4d2efa762d64b36473f50e4436b063f52c4cdec33e",
...
cc_library(
    ...
    core_arch_checker_hash="11eb2eeec5f9de1f4b1234fe04bf35e1631f94a2"
    maybe(
        http_archive,
    ...
    testgen_hash="e88d98f580613d6aefd2ec567960c1f123c5912c"
    maybe(
        git_repository,
        name = "testgen",
        commit = testgen_hash,
