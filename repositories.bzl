...
def rv_tester_repositories():
    ...
    corearchcoverage_hash="b878941276f3789f8ecd947e1ea4f06516e8fe09"
    maybe(
        git_repository,
    ...
    whisper_hash="34c5a57bf3cec226108f8cb7118cbd09aa28bf21"
    maybe(
        git_repository,
        name = "whisper",
        commit = whisper_hash,
    ...
    opensrc_axi_llc_hash="e5a049db907aa0e9c27798caf7ba44ebce88b165"
    maybe(
        git_repository,
