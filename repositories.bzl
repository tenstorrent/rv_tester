...
def rv_tester_repositories():
    ...
    core_arch_coverage_hash="27256a48f0e43b9b54a56eaca1b0d933413d0ae0"
    maybe(
        git_repository,
    ...
    cvm_hash="e498102b268895df82eb943ade58d54f349bb99c"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "71a638ee9128c1fb7c45a21982f30830bf236e7a197a58a7d5bd788374c19333",
...
cc_library(
    ...
    whisper_hash="67dbddf68fa44b2239f4ba2ddc4207238fc9b6c6"
    maybe(
        git_repository,
        name = "whisper",
        commit = whisper_hash,
