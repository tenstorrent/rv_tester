...
def rv_tester_repositories():
    ...
    cvm_hash="411ebe896b75bca4645c094d8749de3242fad2eb"
    maybe(
        http_archive,
        name = "cvm",
        sha256 = "3362a092aaeb925655186d51e098c58198ca6ac8e689a464edba6762777ef6b8",
...
cc_library(
    ...
    axi_wrapper_hash="dd0a4ef052dee5f0215060ef0ad34bf834251be6"
    maybe(
        git_repository,
        name = "axi-wrapper",
