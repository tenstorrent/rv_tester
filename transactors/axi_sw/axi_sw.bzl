...
_generate_axi_interfaces = rule(
    ...
    attrs = {
        ...
        "_gen": attr.label(
            default = "@rv_tester//transactors/axi_sw:gen_axi_interfaces",
            executable = True,
            cfg = "exec",
        ),
    },
...
def axi_sw_gen(name, packet, visibility = None, cc_attrs = {}, **kwargs):
    ...
    native.cc_library(
        ...
        hdrs = [
            ...
            "@rv_tester//transactors/axi_sw:axi_sw_plusargs.h",
            "@rv_tester//transactors/axi_sw:axi_sw_mst.h",
            "@rv_tester//transactors/axi_sw:axi_sw_mst_plusargs.h",
