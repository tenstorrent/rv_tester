...
if __name__ == '__main__':
    ...
    print("risc_p_cores_test_executor --name infinite_2c_verilator --test infinite --simulator verilator --tb sw_testbench:sw_2c_tb --run-arg +nostandalone +eot=max_instr +max_instr=2 +num_harts=2")
