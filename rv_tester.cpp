...
DEFINE_bool(offline_dpi, false, "Set to true for offline DPI mode");
    ...
    void rv_tester_streaming_dpi_shutdown() {
        if (FLAGS_offline_dpi) {
            ...
            if (!rv_tester_shutdown_registry()) {
                cvm::log(cvm::ERROR, "Error: [offline_dpi] failed to shutdown registry\n");
            }
