...
namespace {
  ...
  std::vector<uint32_t> patch_header = {
    ...
    0x00013023,        //0x4214c03c  	    sd	zero,0(sp)
    0x00313c23,        //0x4214c040 :    	sd	gp,24(sp)
    0x02413023,        //0x4214c044 :    	sd	tp,32(sp)
    0x02513423,        //0x4214c048 :    	sd	t0,40(sp)
    0x02613823,        //0x4214c04c :    	sd	t1,48(sp)
    0x02713c23,        //0x4214c050 :    	sd	t2,56(sp)
    0x04813023,        //0x4214c054 :    	sd	s0,64(sp)
    0x04913423,        //0x4214c058 :    	sd	s1,72(sp)
    0x04a13823,        //0x4214c05c :    	sd	a0,80(sp)
    0x04b13c23,        //0x4214c060 :    	sd	a1,88(sp)
    0x06c13023,        //0x4214c064 :    	sd	a2,96(sp)
    0x06d13423,        //0x4214c068 :    	sd	a3,104(sp)
    0x06e13823,        //0x4214c06c :    	sd	a4,112(sp)
    0x06f13c23,        //0x4214c070 :    	sd	a5,120(sp)
    0x09013023,        //0x4214c074 :    	sd	a6,128(sp)
    0x09113423,        //0x4214c078 :    	sd	a7,136(sp)
    0x09213823,        //0x4214c07c :    	sd	s2,144(sp)
    0x09313c23,        //0x4214c080 :    	sd	s3,152(sp)
    0x0b413023,        //0x4214c084 :    	sd	s4,160(sp)
    0x0b513423,        //0x4214c088 :    	sd	s5,168(sp)
    0x0b613823,        //0x4214c08c :    	sd	s6,176(sp)
    0x0b713c23,        //0x4214c090 :    	sd	s7,184(sp)
    0x0d813023,        //0x4214c094 :    	sd	s8,192(sp)
    0x0d913423,        //0x4214c098 :    	sd	s9,200(sp)
    0x0da13823,        //0x4214c09c :    	sd	s10,208(sp)
    0x0db13c23,        //0x4214c0a0 :    	sd	s11,216(sp)
    0x0fc13023,        //0x4214c0a4 :    	sd	t3,224(sp)
    0x0fd13423,        //0x4214c0a8 :    	sd	t4,232(sp)
    0x0fe13823,        //0x4214c0ac :    	sd	t5,240(sp)
    0x0ff13c23,        //0x4214c0b0 :    	sd	t6,248(sp)
    0x7b206f73,        //0x4214c0b4 :    	csrrsi	t5,dscratch0,0
    0x7b306ff3,        //0x4214c0b8 :    	csrrsi	t6,dscratch1,0
    0x01e13423,        //0x4214c0bc :    	sd	t5,8(sp)
    0x01f13823,        //0x4214c0c0 :    	sd	t6,16(sp)
    0x7c8061f3,        //0x4214c0c4 :    	csrrsi	gp,0x7c8,0
    0x7b006273,        //0x4214c0c8 :    	csrrsi	tp,dcsr,0
    0x1c027213,        //0x4214c0cc :    	andi	tp,tp,448
    0x00625213,        //0x4214c0d0 :    	srli	tp,tp,0x6
    0x00621213,        //0x4214c0d4 :    	slli	tp,tp,0x6
    0x00408233,        //0x4214c0d8 :    	add	tp,ra,tp
    0x40020213,        //0x4214c0dc :    	addi	tp,tp,1024 # 400 <tohost-0x6ffffc00>
    0x7b106f73,        //0x4214c0e0 :    	csrrsi	t5,dpc,0
    0x00020067,        //0x4214c0e4 :    	jr	tp # 0 <tohost-0x70000000>
    0x7b109073,        //0x4214c0e8 :    	csrw	dpc,ra
    0x7c9020f3,        //0x4214c0ec :    	csrr	ra,0x7c9
    0xffe0f093,        //0x4214c0f0 :    	andi	ra,ra,-2
    0x7c909073,        //0x4214c0f4 :    	csrw	0x7c9,
    0x7ca060f3,        //0x4214c0f8 :    	csrrsi	ra,0x7ca,0
    0x00c0d093,        //0x4214c0fc :    	srli	ra,ra,0xc
    0x00c09093,        //0x4214c100 :    	slli	ra,ra,0xc
    0xf1406173,        //0x4214c104 :    	csrrsi	sp,mhartid,0
    0x00717113,        //0x4214c108 :    	andi	sp,sp,7
    0x00811113,        //0x4214c10c :    	slli	sp,sp,0x8
    0x00110133,        //0x4214c110 :    	add	sp,sp,ra
    0x78010113,        //0x4214c114 :    	addi	sp,sp,1920
    0x78010113,        //0x4214c118 :    	addi	sp,sp,1920
    0x60010113,        //0x4214c11c :    	addi	sp,sp,1536
    0x00813f03,        //0x4214c120 :    	ld	t5,8(sp)
    0x01013f83,        //0x4214c124 :    	ld	t6,16(sp)
    0x7b2f1073,        //0x4214c128 :    	csrw	dscratch0,t5
    0x7b3f9073,        //0x4214c12c :    	csrw	dscratch1,t6
    0x01813183,        //0x4214c130 :    	ld	gp,24(sp)
    0x02013203,        //0x4214c134 :    	ld	tp,32(sp)
    0x02813283,        //0x4214c138 :    	ld	t0,40(sp)
    0x03013303,        //0x4214c13c :    	ld	t1,48(sp)
    0x03813383,        //0x4214c140 :    	ld	t2,56(sp)
    0x04013403,        //0x4214c144 :    	ld	s0,64(sp)
    0x04813483,        //0x4214c148 :    	ld	s1,72(sp)
    0x05013503,        //0x4214c14c :    	ld	a0,80(sp)
    0x05813583,        //0x4214c150 :    	ld	a1,88(sp)
    0x06013603,        //0x4214c154 :    	ld	a2,96(sp)
    0x06813683,        //0x4214c158 :    	ld	a3,104(sp)
    0x07013703,        //0x4214c15c :    	ld	a4,112(sp)
    0x07813783,        //0x4214c160 :    	ld	a5,120(sp)
    0x08013803,        //0x4214c164 :    	ld	a6,128(sp)
    0x08813883,        //0x4214c168 :    	ld	a7,136(sp)
    0x09013903,        //0x4214c16c :    	ld	s2,144(sp)
    0x09813983,        //0x4214c170 :    	ld	s3,152(sp)
    0x0a013a03,        //0x4214c174 :    	ld	s4,160(sp)
    0x0a813a83,        //0x4214c178 :    	ld	s5,168(sp)
    0x0b013b03,        //0x4214c17c :    	ld	s6,176(sp)
    0x0b813b83,        //0x4214c180 :    	ld	s7,184(sp)
    0x0c013c03,        //0x4214c184 :    	ld	s8,192(sp)
    0x0c813c83,        //0x4214c188 :    	ld	s9,200(sp)
    0x0d013d03,        //0x4214c18c :    	ld	s10,208(sp)
    0x0d813d83,        //0x4214c190 :    	ld	s11,216(sp)
    0x0e013e03,        //0x4214c194 :    	ld	t3,224(sp)
    0x0e813e83,        //0x4214c198 :    	ld	t4,232(sp)
    0x0f013f03,        //0x4214c19c :    	ld	t5,240(sp)
    0x0f813f83,        //0x4214c1a0 :    	ld	t6,248(sp)
    0x7b2060f3,        //0x4214c1a4 :    	csrrsi	ra,dscratch0,0
  ...
  std::vector<uint32_t> patch_body_sub = {
    ...
    0x4214cfb7,          //	lui	t6,0x4214c
    0x0e8f8f9b,          //	addiw	t6,t6,232 # 4214c0e8 <preg3+0x147050>
    0x000f8067,          //	jr	t6
  };
