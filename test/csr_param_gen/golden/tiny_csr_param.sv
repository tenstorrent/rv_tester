...
parameter logic [7:0] MY_CTL_CFG_SEL_RESET = 8'h0A;
...
parameter logic [3:0] ADDON_STATUS_FLAGS_RESET = 4'h0;
parameter logic [63:0] ADDON_STATUS_FLAGS_MASK = 64'h00000000F0000000;
parameter string ADDON_STATUS_FLAGS_SW_TYPE = "WARL";

parameter int ADDON_STATUS_CROSSING_MSB = 35;
parameter int ADDON_STATUS_CROSSING_LSB = 32;
parameter int ADDON_STATUS_CROSSING_WIDTH = 4;
parameter logic [3:0] ADDON_STATUS_CROSSING_RESET = 4'h0;
parameter logic [63:0] ADDON_STATUS_CROSSING_MASK = 64'h0000000000000000;
parameter string ADDON_STATUS_CROSSING_SW_TYPE = "WARL";
...
`define ADDON_STATUS_CROSSING_GET(csr_val) \
    `CSR_FIELD_GET(csr_val, 35, 32)

`define ADDON_STATUS_CROSSING_SET(csr_val, field_val) \
    `CSR_FIELD_SET(csr_val, field_val, 35, 32)
