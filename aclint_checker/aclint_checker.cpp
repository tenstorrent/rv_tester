...
extern "C" void AcPrintErrMsg(uint64_t clock, uint32_t hart, uint32_t msg_num) {
    switch (msg_num) {
        case 0:
            cvm::log(cvm::ERROR, "[{}] Error: Hart {}, Not recieved aclint force sync\n", clock, hart);
            break;
        case 1:
            cvm::log(cvm::ERROR, "[{}] Error: Hart {}, Did not expect MTIP, but MTIP generated\n", clock, hart);
            break;
        case 2:
            cvm::log(cvm::ERROR, "[{}] Error: Hart {}, Expected MTIP, but MTIP not generated\n", clock, hart);
            break;
        case 3:
            cvm::log(cvm::ERROR, "[{}] Error: MTIP[8] generated by Aclint but not seen at SMC port\n", clock);
            break;
    }
}