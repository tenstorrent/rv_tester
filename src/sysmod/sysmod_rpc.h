...
inline constexpr const char* sysmod_external_device_type = "external";
CVM_MESSENGER_procedure_call(sysmod_add_device, void(std::shared_ptr<device>)); // project device registration; memmap entry of type "external" reserves the address range