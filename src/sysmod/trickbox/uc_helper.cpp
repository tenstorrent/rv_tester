...
void uc_helper::update_mem_model(uc_helper::trickbox_mem_req_t& i) {
...
void uc_helper::read_dev(uint64_t addr, size_t length, data_t& data) {
...
void uc_helper::checkUsage() {
  //For Future FLAG usage
}

void uc_helper::write(uint64_t addr, size_t, const data_t& data,
                      const strb_t&) {
