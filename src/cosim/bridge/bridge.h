...
private:
  ...
  void update_whisper_state(hart_id_t hart, whisper_state_t& w, bool dut_is_compressed = false, bool page4kX = false, bool dut_opcode_modified = false, bool dut_ucode = false);
