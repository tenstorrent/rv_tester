...
public:
  ...
  virtual void process_dut_mcm_ncio_complete(hart_id_t hart, mem_t& m, bool cache) = 0;
  virtual void process_dut_mcm_ncio_visible(hart_id_t hart, mem_t& m, bool cache) = 0;
