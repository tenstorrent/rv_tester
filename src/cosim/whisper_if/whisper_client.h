...
class whisperClient {
  ...
  public:
    ...
    static bool constructSystem(std::shared_ptr<WdRiscv::Session<URV>>&, std::shared_ptr<WdRiscv::System<URV>>&, WdRiscv::Args&, uint16_t ncores, bool standalone, uint64_t restart_pc = 0, std::string logfile="");
