...
public:
  ...
  bool parse() {
    ...
    std::sort(vec_m.begin(), vec_m.end(), [](const std::pair<std::string, memmap_entry_t>& a, const std::pair<std::string, memmap_entry_t>& b) { return a.second.base < b.second.base; });
