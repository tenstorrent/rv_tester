...
#(
    ...
    assign terminate           = (rv_tester_error_terminate.terminate || ((sysmod_terminate.terminate || cosim_terminate_any || dmi_poll_timeout_terminate) && !sys_reset[TB_RESET_IDX]) || quiesce_counter > 0) && !rv_tester_reset;
