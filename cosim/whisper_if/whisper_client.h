...
class whisperClient {
  ...
  {}
    ...
    bool whisperMcmRead(int hart, uint64_t time, uint64_t instrTag, uint64_t addr, unsigned size, uint64_t value, bool internal, bool& valid);
    ...
    bool whisperCheckInterrupt(int hart, uint64_t mip, bool& interrupt);
