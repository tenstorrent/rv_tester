    ...
    csr_cac_(CacCore(num_harts))
{
    ...
    cosim_resynch_csr_defaults = {
      "htval","mtval2","mtinst","htinst","vstart","vxsat","vxrm","vcsr","sstatus","mstatus","mie","hie","vsie","sie","fflags","fcsr","tselect","tdata1","tdata2","tdata3","mcontext","dcsr","dpc","dscratch0","dscratch1", // open bugs: RVDE: 10005 (mtinst/htinst), RVDE: 11217 (vectors), RVDE: 10043 (mtval2/htval), RVDE: 8849 (mstatus/mie aliases), Debug CSRs
