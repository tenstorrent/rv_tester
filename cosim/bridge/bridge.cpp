    ...
    csr_cac_(CacCore(num_harts))
{
    ...
    cosim_resynch_csr_defaults = {"htval","mtval2","mip","hip","vsip","hvip","mtinst","htinst","vstart","vxsat","vxrm","vcsr","sstatus","mstatus","fcsr","mie","hie","vsie","mireg","sireg","fflags","mcycle"}; // RVDE: 10005 (mtinst/htinst), RVDE: 11217 (vectors), RVDE: 10043 (mtval2/htval), RVDE-12092 (mcycle)
