...
// First/last uops for ucode sequences
  ...
  instr.mem_read.page4kX = m_rvfi.page4kX;
  instr.mem_read.page4kX_attr = m_rvfi.page4kX_mem_attr;
  ...
  instr.mem_write.page4kX = m_rvfi.page4kX;
  instr.mem_write.page4kX_attr = m_rvfi.page4kX_mem_attr;
