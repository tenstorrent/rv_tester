...
//AUTOGENERATED -- NO TOUCH
    ...
    const std::unordered_map<uint64_t, size_t> event_map = {
      ...
      {0xafc20ff1,counter::LS_REPLAY_LOAD},
      {0xafc20ff2,counter::LS_REPLAY_STORE},
      {0xafc20ff4,counter::LS_REPLAY_PREFETCH},
      {0xafc20ff8,counter::LS_REPLAY_MMU},
      {0xafc20fff,counter::LS_REPLAY_ALL},
