...
#(
  ...
  `RV_TESTER_TRANSACTIONS_PMU_OUTPUT_PORTS
   ...
   endgenerate
    ...
    assign pmcounterss[0].data.ptc_ifbuf_full_redirect = ptc_evt_count[IFBUF_FULL_REDIRECT];
    ...
    assign pmcounterss[0].data.ptc_l1d_cache_invalidate_all = ptc_evt_count[L1D_CACHE_INVALIDATE_ALL];
    ...
    assign pmcounterss[0].data.ptc_pfc_useless_prefetches = ptc_evt_count[PFC_USELESS_PREFETCHES];
