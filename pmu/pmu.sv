...
#(
  ...
  `RV_TESTER_TRANSACTIONS_PMU_OUTPUT_PORTS
   ...
   endgenerate
    ...
    assign pmcounterss[0].valid = !reset && perf_enabled && (terminate || (sync & (sync_cycles % period) == 0) || perf_start || perf_end);
    ...
    assign pmcounterss[0].data.sync = sync & (sync_cycles % period) == 0;
