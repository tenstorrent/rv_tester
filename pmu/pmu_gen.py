...
for event in core_events:
    ...
    if event:
        desc = event.split(',')
        core_data_dict.append({"name": desc[1], "description": desc[2], "event_id": desc[0]})
core_data_dict.append({"name": "branch_instructions", "description": "Sum of retired branches", "event_id": -1})
